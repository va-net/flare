                ...
                <div class="col-lg-9 main-content">
                    ...
                    <div class="loaded">
                        ...
                        <?php else : ?>
                            ...
                            if ($setupIfc) :
                                Session::flash('success', 'PIREPs set up successfully. No action is required.');
                            ?>
                                <script>
                                    window.location.href = "/pireps.php?page=<?= Input::get('page') ?>";
                                </script>
                            <?php
                            else :
                                $server = 'casual';
                            ...
                            ?>
                                <p>
                                    ...
                                    Please turn on "Show Username In-Flight" in your Infinite Flight Settings,
                                    start a quick flight to let it refresh, then come back here and reload the page.
                                </p>
                            <?php endif; ?>
                        <?php endif; ?>
                    </div>
