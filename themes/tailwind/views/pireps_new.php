...
<div id="content" class="m-5">
    ...
    <form method="post" class="space-y-2 text-black dark:text-white" id="file-pirep">
        <div class="space-y-1">
            ...
            <input id="date" name="date" type="date" value="<?= empty(Input::get('date')) ? date('Y-m-d') : Input::get('date') ?>" required class="block w-full border-gray-300 rounded-md shadow-sm dark:border-transparent focus:shadow-md focus:ring-primary focus:ring-2 dark:bg-white dark:bg-opacity-10 dark:text-white" />
        </div>
        <div class="space-y-1">
            <label for="fnum">Flight Number</label>
            <input id="fnum" name="fnum" type="text" value="<?= Input::get('fnum') ?>" required class="block w-full border-gray-300 rounded-md shadow-sm dark:border-transparent focus:shadow-md focus:ring-primary focus:ring-2 dark:bg-white dark:bg-opacity-10 dark:text-white" placeholder="123AB" />
        </div>
        ...
        <div class="space-y-1">
            ...
            <input id="fuel" name="fuel" type="number" value="<?= Input::get('fuel') ?>" required class="block w-full border-gray-300 rounded-md shadow-sm dark:border-transparent focus:shadow-md focus:ring-primary focus:ring-2 dark:bg-white dark:bg-opacity-10 dark:text-white" placeholder="1234" />
        </div>
        <div class="space-y-1">
            <label for="dep">Departure ICAO</label>
            <input id="dep" name="dep" type="text" value="<?= Input::get('dep') ?>" maxlength="4" required class="block w-full border-gray-300 rounded-md shadow-sm dark:border-transparent focus:shadow-md focus:ring-primary focus:ring-2 dark:bg-white dark:bg-opacity-10 dark:text-white" placeholder="KLAX" />
        </div>
        <div class="space-y-1">
            <label for="arr">Arrival ICAO</label>
            <input id="arr" name="arr" type="text" value="<?= Input::get('arr') ?>" maxlength="4" required class="block w-full border-gray-300 rounded-md shadow-sm dark:border-transparent focus:shadow-md focus:ring-primary focus:ring-2 dark:bg-white dark:bg-opacity-10 dark:text-white" placeholder="KJFK" />
        </div>
        <div class="space-y-1">
        ...
        <div class="mb-1 space-y-1">
            ...
            <input id="mutli" name="multi" type="text" value="<?= Input::get('multi') ?>" class="block w-full border-gray-300 rounded-md shadow-sm dark:border-transparent focus:shadow-md focus:ring-primary focus:ring-2 dark:bg-white dark:bg-opacity-10 dark:text-white" placeholder="123456" />
        </div>
    </form>
