        ...
        <div class="col-span-5 p-4 border border-gray-200 rounded-lg shadow-lg dark:border-transparent dark:bg-white dark:bg-opacity-5 dark:text-white">
            ...
            <form action="/routes/search" method="get">
                <label class="block mb-2">
                    ...
                    <input required type="text" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm dark:border-transparent focus:shadow-md focus:ring-primary focus:ring-2 dark:bg-white dark:bg-opacity-10 dark:text-white" name="dep" placeholder="YMML" />
                </label>
                <label class="block mb-3">
                    <span class="text-black dark:text-white">Arrival ICAO</span>
                    <input required type="text" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm dark:border-transparent focus:shadow-md focus:ring-primary focus:ring-2 dark:bg-white dark:bg-opacity-10 dark:text-white" name="arr" placeholder="YSSY" />
                </label>
