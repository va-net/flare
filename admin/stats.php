                    ...
                    <div class="loaded">
                        ...
                        <table class="table">
                            <tr>
                                ...
                                <td><?php echo Time::secsToString(Stats::totalHours()); ?></td>
                            </tr>
                            <tr>
                                <td><b>Total Flights</b></td>
                                <td><?php echo Stats::totalFlights(); ?></td>
                            </tr>
                            <tr>
                                <td><b>Total Pilots</b></td>
                                <td><?php echo Stats::numPilots(); ?></td>
                            </tr>
                            <tr>
                                <td><b>Total Routes</b></td>
                                <td><?php echo Stats::numRoutes(); ?></td>
                            </tr>
                        </table>
                        <hr />
                        <?php if (!$IS_GOLD) : ?>
                        ...
                        <?php else : ?>
                            ...
                            <table class="table">
                                <tr>
                                    ...
                                    <td>v$<?php echo $stats["totalRevenue"]; ?></td>
                                </tr>
                                <tr>
                                    <td><b>Event Count</b></td>
                                    <td><?php echo $stats["eventCount"]; ?></td>
                                </tr>
                            </table>
                        <?php endif; ?>
                    </div>
